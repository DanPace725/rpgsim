...
void RPEngine::registerGeometryRule(const std::string& name, RuleFunction rule) {
    m_geometryRules.emplace_back(name, rule);
}

void RPEngine::registerConstraintRule(const std::string& name, RuleFunction rule) {
    m_constraintRules.emplace_back(name, rule);
}

void RPEngine::registerEpistemicRule(const std::string& name, RuleFunction rule) {
    m_epistemicRules.emplace_back(name, rule);
}

void RPEngine::registerDynamicsRule(const std::string& name, RuleFunction rule) {
